...
*
*/
enum { CODEC_CUVID, CODEC_NONE, GB28181_H264 = 28, GB28181_MPEG4 = 13, GB28181_SVAC, GB28181_NONE };
...
struct DecodeParam
{
    int   skip_frame_size = 0;  // define skip frame size, 0 indicates no frame will be skipped
