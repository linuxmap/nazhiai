========================================================================
    动态链接库：FaceDetector 项目概述
========================================================================

应用程序向导已为您创建了此 FaceDetector DLL。

本文件概要介绍组成 FaceDetector 应用程序的每个文件的内容。
...
StdAfx.h, StdAfx.cpp
    这些文件用于生成名为 FaceDetector.pch 的预编译头 (PCH) 文件和名为 StdAfx.obj 的预编译类型文件。
